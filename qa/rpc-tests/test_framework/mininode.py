# mininode.py - mitcoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a mitcoin node
...
# Objects that map to mitcoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in mitcoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to mitcoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
