The following is a list of assets used in the mitcoin source and their proper attribution.
...
* mitcoin Icon: (based on the original mitcoin logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/mitcoin.icns, src/qt/res/icons/mitcoin.ico,
    src/qt/res/icons/mitcoin.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/mitcoin.svg,
