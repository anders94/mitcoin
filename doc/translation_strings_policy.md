...
This document provides guidelines for internationalization of the mitcoin Core software. 
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mitcoin_en.ts` remains unchanged.
