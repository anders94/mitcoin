mitcoin Core version 0.11.1 is now available from:

  <https://mitcoin.org/bin/mitcoin-core-0.11.1/>
...
backwards-compatible with pre-0.10 versions of mitcoin Core or other software:
...
(see https://github.com/mitcoin/mitcoin/pull/6795).
...
one was randomly violated by all deployed mitcoin software prior to
...
mitcoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; mitcoinj has done so for a similar span of time.
mitcoinjs and electrum have been more recently updated.
...
[1] On the Malleability of mitcoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/mitcoin/paper_9.pdf
...
(see https://github.com/mitcoin/mitcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libmitcoinconsensus: avoid a crash in multi-threaded environments
