mitcoin Core version 0.9.4 is now available from:

  https://mitcoin.org/bin/0.9.4/
...
this update is incompatible with the mitcoin system and could lead to consensus
forks.

mitcoin Core released binaries from https://mitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mitcoin/+archive/ubuntu/mitcoin
- A third-party or self-compiled mitcoin Core

upgrade to mitcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
