mitcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mitcoin/files/mitcoin/mitcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the mitcoin
...
New/changed settings (command-line or mitcoin.conf file)
--------------------------------------------------------
