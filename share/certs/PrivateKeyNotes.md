...
unlocked to sign the mitcoin-Qt.app bundle.
...
allowing somebody to distribute a mitcoin-Qt.app or mitcoin-qt-setup.exe with a valid
...
that the mitcoin-qt.exe file inside the installer had not been tampered with.
