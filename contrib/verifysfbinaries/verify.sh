...
###   This script attempts to download the signature file SHA256SUMS.asc from mitcoin.org
...
WORKINGDIR="/tmp/mitcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://mitcoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://mitcoin.org/bin/"
VERSIONPREFIX="mitcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'mitcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[mitcoin-]<version>-[rc[0-9]] (example: mitcoin-0.9.2-rc1)"
   echo "wget output:"
