...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/mitcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("mitcoin Core"),
     ...
     * override -datadir in the mitcoin.conf file in the default data directory
     * (to be consistent with mitcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
