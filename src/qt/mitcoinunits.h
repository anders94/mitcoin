...
#ifndef mitcoin_QT_mitcoinUNITS_H
#define mitcoin_QT_mitcoinUNITS_H
...
/** mitcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class mitcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit mitcoinUnits(QObject *parent);

    /** mitcoin units.
      @note Source: https://en.mitcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef mitcoinUnits::Unit mitcoinUnit;

#endif // mitcoin_QT_mitcoinUNITS_H
