...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CmitcoinAddress demoAddress = CmitcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CmitcoinAddress setaccountDemoAddress = CmitcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CmitcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CmitcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
