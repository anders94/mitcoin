...
#ifndef mitcoin_RPCPROTOCOL_H
#define mitcoin_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! mitcoin is not connected
