...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("mitcoin Core mitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mitcoin transaction") + "\n" +
              "  mitcoin-tx [options] -create [commands]   " + _("Create hex-encoded mitcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mitcoin transaction
